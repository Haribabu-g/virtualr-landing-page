  ...
  return (
    <div className='relative mt-20 border-b border-neutral-800 min-h-[800px]'>
        <div className="text-center">
            ...
            <h2 className='text-3xl sm:text-5xl lg:text-xl mt-10 lg:mt-20 trackingWide'>
                Easily build
                <span className='bg-gradient-to-r from-blue-500 to-blue-800 text-transparent bg-clip-text'>{" "} your code</span>
            </h2>
        </div>
        <div className="flex flex-wrap mt-10 lg:mt-20">{features.map((feature,index)=>(<div key={index} className='w-full sm:1/2 lg:w-1/3'> 
        <div className='flex'>
